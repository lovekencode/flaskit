...
class ProjectCommand(Command):
    """
    Creates a new Flaskit project

    new
        {target? : Path of you Flaskit project}
        {--b|--branch=False : Specify which branch from the Flaskit repo you would like to install}
        {--r|--release=False : Specify which version of Flaskit you would like to install}
        {--repo=FlaskitFramework/cookie-cutter : Specify from which repository you want to flaskit your project}
        {--p|--provider=github : Specify from which repository you want to flaskit your project github, gitlab }
    """
    ...
    def handle(self):
        ...
        if success:
            ...
            if target == ".":
                ...
                self.call("install")
                self.info(
                    "Installed Successfully. Just Run `python flaskit serve` To Start Your Application."
                )
            else:
                self.info(
