class TableNotFound:
    ...
    def description(self):
        return "You are trying to make a query on a table that cannot be found. Check that :table migration exists and that migrations have been ran with 'python flaskit migrate' command."
